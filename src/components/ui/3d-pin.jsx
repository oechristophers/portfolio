...
//   children,
//   title,
//   href = "/", // Default href to prevent undefined values
//   className,
//   containerClassName,
// }) => {
...
// }) => {
//   return (
//     <motion.div className="pointer-events-none  w-full h-80 flex text-white items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
